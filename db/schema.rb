...
ActiveRecord::Schema.define(version: 20190112195651) do
  ...
  create_table "attorney_users", force: :cascade do |t|
    t.string   "first_name", null: false
    t.string   "last_name",  null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["first_name"], name: "index_attorney_users_on_first_name", using: :btree
    t.index ["last_name"], name: "index_attorney_users_on_last_name", using: :btree
  end
